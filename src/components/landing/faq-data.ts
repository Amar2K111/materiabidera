export const FAQ_ITEMS = [
  ...
  {
    q: "Puis-je vérifier d’où vient une information ?",
    a: "Oui. Les exigences renvoient au document et à la page dont elles proviennent, et les passages générés indiquent les pièces du DCE et les éléments de votre base entreprise sur lesquels ils s’appuient.",
  },
  {
    q: "Que se passe-t-il si une information n’existe pas chez nous ?",
    a: "Elle est signalée comme manquante plutôt que comblée. Une certification absente ou une attestation introuvable apparaît dans les alertes et dans la checklist, pour que vous alliez la chercher au lieu de découvrir le trou après le dépôt.",
  },
  {
    q: "Puis-je exporter mon mémoire ?",
  ...
  },
  {
    ...
    a: "Vos pièces de marché et votre base entreprise ne sont pas utilisées pour entraîner un modèle partagé avec d’autres entreprises. Elles servent à répondre à vos propres appels d’offres. Le détail des traitements et des sous-traitants techniques vous est fourni par écrit.",
  },
  {
    q: "Combien de temps faut-il pour démarrer ?",
    a: "L’analyse d’un DCE ne demande aucune installation. Le vrai investissement de départ est la constitution de votre base entreprise : plus elle est complète, plus les réponses générées sont spécifiques. Vous pouvez commencer avec quelques références et l’enrichir dossier après dossier.",
  },
] as const;
